...
async Task<bool> AddZapisnik(ElasticClient client, Zapisnik zapisnik)
{    
    var asyncIndexResponse = await client.IndexDocumentAsync(zapisnik);
    return asyncIndexResponse.IsValid;
}
...
//    KatastarskaParcela = "123456"
//};

//var res = await AddZapisnik(client, zapisnik);
